...
---
***Feeling confident with your code? If not, remember, just ask Aiya!***
...
> [!NOTE]
> Not sure what '*tuples*' are? Auth0's [FGA documentation](https://docs.fga.dev/fga-concepts#what-is-a-relationship-tuple) can help!

In the lab, we are obviously simulating non-real-world situations. *Normally* when an account is *initially created* (*or permissions modified in other ways*) the permissions would be set as tuples in FGA.

***Because your account data was auto-generated, you don't have any permissions!***

Don't worry, to save time, we've created a shortcut for you.
