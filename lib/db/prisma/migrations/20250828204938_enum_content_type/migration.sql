...
INSERT INTO "new_LocalContent" ("contentText", "createdAt", "expiresAt", "id", "lastSyncedAt", "mimeType", "name", "type") SELECT "contentText", "createdAt", "expiresAt", "id", "lastSyncedAt", "mimeType", "name", "type" FROM "LocalContent";
