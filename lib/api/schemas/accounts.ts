...
export const AccountListSchema = z.object({
	id: AccountRootSchema.shape.id,
	displayName: AccountRootSchema.shape.displayName.optional(),
	name: AccountRootSchema.shape.name,
	number: AccountRootSchema.shape.number,
	type: AccountRootSchema.shape.type,
